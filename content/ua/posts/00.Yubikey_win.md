...
draft = false
title = '0x00. YubiKey + SSH/Git під Windows'
description = 'Покрокове керівництво з налаштування PIV-сертифікатів YubiKey та їх використання для SSH і git-автентифікації у Windows через PKCS#11.'
+++
