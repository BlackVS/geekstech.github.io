...
draft = false
title = '0x01. YubiKey + SSH/Git під Linux'
description = 'Як налаштувати PIV-сертифікати YubiKey та використовувати їх для SSH і git-автентифікації у Linux за допомогою OpenSSH та PKCS#11.'
+++
